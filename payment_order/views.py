...
class StartPayment(generics.GenericAPIView):
    ...
    def post(self, request, id=None, format=None):
        ...
        payment = client.order.create({"amount": int(order_amount) * 100, 
                                    "currency": "INR", 
                                    "payment_capture": "1"})    
        ...
        # function
        order = Order.objects.create(order_product=order_product, 
...
class HandlePaymentSuccess(generics.GenericAPIView):
...
class HandlePaymentSuccessMessage(generics.GenericAPIView):
    '''payment message recive successfully'''
